...
/*
  var verticesColors = new Float32Array([
    // Vertex coordinates and color
     0.0,  0.5, 0.8,    0.4,  0.4,  1.0,  // The front blue one 
    -0.5, -0.5, 0.8,    0.4,  0.4,  1.0,
     0.5, -0.5, 0.8,    1.0,  0.4,  0.4, 
  ]);
*/
  var n = 9;
...
var g_EyeX = 1.3, g_EyeY = 0.0, g_EyeZ = 1.0; // Eye position
//var g_EyeX = 0.0, g_EyeY = 0.0, g_EyeZ = 0.0; // Eye position
