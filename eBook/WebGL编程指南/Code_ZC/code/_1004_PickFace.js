...
/*
  ...
  var colors = new Float32Array([   // Colors	// ZC: Ç°:·Û; ºó:»Ò; ÉÏ×óÏÂÓÒ: ºìÂÌÀ¶°×
    1.00, 0.75, 0.80,  1.00, 0.75, 0.80,  1.00, 0.75, 0.80,  1.00, 0.75, 0.80, // v0-v1-v2-v3 front	·Û
    1.00, 1.00, 1.00,  1.00, 1.00, 1.00,  1.00, 1.00, 1.00,  1.00, 1.00, 1.00, // v0-v3-v4-v5 right	°×
    1.00, 0.00, 0.00,  1.00, 0.00, 0.00,  1.00, 0.00, 0.00,  1.00, 0.00, 0.00, // v0-v5-v6-v1 up	ºì
    0.00, 1.00, 0.00,  0.00, 1.00, 0.00,  0.00, 1.00, 0.00,  0.00, 1.00, 0.00, // v1-v6-v7-v2 left	ÂÌ
    0.00, 0.00, 1.00,  0.00, 0.00, 1.00,  0.00, 0.00, 1.00,  0.00, 0.00, 1.00, // v7-v4-v3-v2 down	À¶
    0.41, 0.41, 0.41,  0.41, 0.41, 0.41,  0.41, 0.41, 0.41,  0.41, 0.41, 0.41, // v4-v7-v6-v5 back	Éî»Ò
   ]);
